...
export default function ChatWindow({
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      // помечаем всё прочитанным сразу
  ...
  useRealtimeConversation(conversationId, handleNewMessage, handleUpdateMessage);
  ...
  async function send() {
    ...
    // и снова помечаем всё прочитанным, вдруг там было входящее
    await fetch(`/api/conversations/${conversationId}/read`, {
      method: 'POST',
      credentials: 'include',
    });
