...
export default function ChatWindow({
  ...
  useEffect(() => {
    (async () => {
      ...
      // отметить входящее как прочитанное
  ...
  // новое входящее сообщение (INSERT)
  ...
  async function send() {
    ...
    // оптимистично добавить новое сообщение
    setChat(prev =>
      prev
